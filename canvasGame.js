...
function setHearts(){
	...
	function Heart(value = 2, src = "heart.gif"){
	this.value = value;
	this.src = src;				
	}
}
...
function update(){
	...
	if((32 in keysDown) && (hero.src == "link_right.png")){
		console.log("right thrust!");
	}

	if((32 in keysDown) && (hero.src == "link_left.png")){
		console.log("left thrust!");
	}

	if(32 in keysDown && hero.src == "link_up.png"){
		console.log("up thrust!");
	}

	if(32 in keysDown && hero.src == "link_down.png"){
